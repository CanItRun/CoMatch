...
class WideResnet(nn.Module):
    ...
    def forward(self, x, return_outputs=True, return_hidden_states=False, return_dict=True):
        ...
        return ResnetOutput(last_hidden_state=out, hidden_states=hidden_states)
        # if self.proj:
        #     feat = self.fc1(feat)
